...
inline time_with_unit duration_ns(time_point start, time_point stop) noexcept {
...
inline time_with_unit duration_us(time_point start, time_point stop) noexcept {
...
inline time_with_unit duration_ms(time_point start, time_point stop) noexcept {
...
inline time_with_unit duration_s(time_point start, time_point stop) noexcept {
